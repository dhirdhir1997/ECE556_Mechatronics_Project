...
fprintf("Place the bot on white surface \n");
waitforbuttonpress;
...
fprintf("Place the bot on black surface \n");
waitforbuttonpress;
...
close all; % close the empty figure
fprintf("Place the middle sensor on red \n");
waitforbuttonpress;
...
filename = 'ECE556-team_9_task3_run2.txt';
